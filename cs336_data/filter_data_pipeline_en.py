...
if __name__ == "__main__":
    ...
    dst_dedup_pre_dir = './data/dedup_pre_en'
    dst_exact_line_dedup_dir = './data/exact_line_dedup_en'
    dst_minhash_dedup_dir = './data/minhash_dedup_en'
    output_path = './data/minhash_dedup_en.np'
